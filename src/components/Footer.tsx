...
const Footer = () => {
  return (
    <>
      <div className="px-[2%] py-[2%] flex flex-row bg-[#06b6d4] float-left w-full relative bottom-0 shadow-lg shadow-[#06b6d4]">
        ...
        <div className='flex-1'>
          <p class="text-sm text-center text-white dark:text-gray-300">
              <span>© 2024 </span> 
              <a href="/" classname="text-primary hover:underline">created using</a> 
              <span> React js</span> <a href="https://creative-tim.com/?ref=tc-footer" classname="text-primary hover:underline">Node Tailwind</a>
          </p>
        </div>
      </div>
    </>
